...
export default function CorporateHeroSection() {
    const texts = [
        "Premium Comfort for Business Stays.",
        "Corporate Hospitality, Redefined.",
    ...
    return (
        <section className="relative w-full h-[calc(100vh-80px)] overflow-hidden">
            {/* Background Image */}
            <img
                src="/corporate-bg.jpg" // 🔥 Replace with a premium guest house / hospitality image
                alt="Corporate Guest House"
            ...
            >
                ...
                >
                    Experience seamless stays designed for business travelers.
                    Our corporate guest houses combine <span className="font-semibold">comfort, convenience, and hospitality</span> —
                    ensuring every trip feels effortless and productive.
                </motion.p>
