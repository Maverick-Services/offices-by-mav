...
export default function VirtualOfficeHeroSection() {
    const texts = [
        "Virtual Offices. Real Impact.",
        "Work Anywhere. Stay Prestigious.",
        "Redefining Business, Virtually.",
    ];
    ...
    return (
        <section className="relative w-full h-[calc(100vh-80px)] overflow-hidden">
            {/* Background Image */}
            <img
                src="/virtual-office-bg.jpg" // 🔥 Replace with your image path
            ...
            >
                ...
                >
                    Build your business presence with our premium virtual office solutions —
                    professional addresses, mail handling, meeting spaces, and global credibility.
                </motion.p>
